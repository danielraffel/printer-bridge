...
OUTPUT_APP="$OUTPUT_DIR/Printer Bridge.app"
ARM64_APP="$DERIVED_DATA_ARM64/Build/Products/Release/Printer Bridge.app"
X86_64_APP="$DERIVED_DATA_X86_64/Build/Products/Release/Printer Bridge.app"
ARM64_DAEMON="$DERIVED_DATA_ARM64/Build/Products/Release/Printer Bridge Daemon"
X86_64_DAEMON="$DERIVED_DATA_X86_64/Build/Products/Release/Printer Bridge Daemon"
OUTPUT_DAEMON="$OUTPUT_APP/Contents/Resources/Printer Bridge Daemon"
